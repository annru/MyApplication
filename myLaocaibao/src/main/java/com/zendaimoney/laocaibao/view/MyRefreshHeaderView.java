...
public class MyRefreshHeaderView extends ArrowRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                com.jcodecraeer.xrecyclerview.R.layout.listview_header, null);
        ...
        mProgressBar = (SimpleViewSwitcher) findViewById(com.jcodecraeer.xrecyclerview.R.id
                .listview_header_progressbar);
