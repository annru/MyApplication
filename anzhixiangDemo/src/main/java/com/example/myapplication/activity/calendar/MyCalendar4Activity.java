...
import com.example.myapplication.view.MyCalendarView;
...
public class MyCalendar4Activity extends AppCompatActivity {
    @Bind(R.id.calendar)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_calendar4);
...
//        calendarRight = (ImageButton) findViewById(R.id.calendarRight);
        ...
        calendar.setOnItemClickListener(new MyCalendarView.OnItemClickListener() {
