...
public class LockIndicator extends View {
    ...
    public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        patternNormal = ContextCompat.getDrawable(paramContext, R.mipmap.lock_pattern_node_normal);
        patternPressed = ContextCompat.getDrawable(paramContext, R.mipmap.lock_pattern_node_pressed);
