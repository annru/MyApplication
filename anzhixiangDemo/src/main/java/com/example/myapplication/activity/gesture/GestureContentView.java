...
public class GestureContentView extends ViewGroup {
    ...
    private int offsetWidth = 0;//解决手势密码圆圈分散问题，设置屏幕左右边距的偏移量
    ...
    public GestureContentView(Context context, boolean isVerify,
        ...
        blockWidth = (int) (width * 0.8 / 3);
        offsetWidth = (int) (width * 0.2 / 2);
    ...
    private void addChild() {
        for (int i = 0; i < 9; i++) {
            ...
            int col = i % 3;
            // 定义点的每个属性
            int leftX = col * blockWidth + blockWidth / baseNum + offsetWidth;
            int topY = row * blockWidth + blockWidth / baseNum;
            int rightX = col * blockWidth + blockWidth - blockWidth / baseNum + offsetWidth;
    ...
    public void setParentView(ViewGroup parent) {
        ...
        int height = 2 * blockWidth + blockWidth - blockWidth / baseNum;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            int col = i % 3;
            View v = getChildAt(i);
            v.layout(col * blockWidth + blockWidth / baseNum + offsetWidth, row
                    * blockWidth + blockWidth / baseNum, col * blockWidth
                    + blockWidth - blockWidth / baseNum + offsetWidth, row
                    * blockWidth + blockWidth - blockWidth / baseNum);
    ...
    public void clearDrawlines() {
        gestureDrawline.clearDrawlines();
    }
